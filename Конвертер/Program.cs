...
namespace Конвертер
{
    class Program
    {
        ...
        static double ConvertHoursToMinutes(double a)
        {
            return a * 60;
        }

        static double ConvertMinutesToSeconds(double a)
        {
            return a * 60;
        }

        static double ConvertSecondsToMinutes(double a)
        {
            return a / 60;
        }

        static double ConvertMinutesToHours(double a)
        {
            return a / 60;
        }

        static double ConvertHoursToDays(double a)
        {
            return a / 24;
        }

        static double ConvertDaysToSeconds(double a)
        {
            return a / 60 * 60 * 24;
        }
